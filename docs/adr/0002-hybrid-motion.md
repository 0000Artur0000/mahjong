...
Первый frontend-план предполагал только custom properties и нативные переходы
без тяжёлых UI-фреймворков. Редизайн «Noir Gold» требует
...
`--stagger-step` в `frontend/src/styles/tokens.css`):
...
- Документация frontend и проверки сборки фиксируют три слоя выше.
