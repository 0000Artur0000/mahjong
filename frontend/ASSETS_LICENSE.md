...
Код проекта распространяется под MIT. Этот файл фиксирует происхождение и
лицензии сторонних и брендовых ассетов: по Plan.md логотип, маскот и
тайл-арт публикуются под отдельной лицензией (не MIT).
